...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("bankDataSet12"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class bankDataSet12
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As bankDataSet12 = CType(MyBase.Clone,bankDataSet12)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "bankDataSet12"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/bankDataSet12.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As bankDataSet12 = New bankDataSet12
...
Namespace bankDataSet12TableAdapters
    ...
    Partial Public Class cust1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT     custid, cname, crelation, relativename, ddate, month, year, gender, re"& _ 
                ...
                "s, username, password"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         cust1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (gender = @aa)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@aa", Global.System.Data.SqlDbType.VarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "gender", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._commandCollection(2).CommandText = "SELECT custid, cname, crelation, relativename, ddate, month, year, gender, religi"& _ 
                "on, category, address, nationality, maritalstatus, ocupation, accountno, account"& _ 
                "type, accountamount, nname, naddress, wname, waddress, username, password FROM  "& _ 
                "cust1 where gender='male'"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(3) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(3).Connection = Me.Connection
            Me._commandCollection(3).CommandText = "SELECT     custid, cname, crelation, relativename, ddate, month, year, gender, re"& _ 
                "ligion, category, address, nationality, maritalstatus, ocupation, accountno, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&" "& _ 
                "                     accounttype, accountamount, nname, naddress, wname, waddres"& _ 
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As bankDataSet12.cust1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As bankDataSet12.cust1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As bankDataSet12.cust1DataTable = New bankDataSet12.cust1DataTable
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As bankDataSet12.cust1DataTable, ByVal aa As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (aa Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(aa,String)
            End If
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy1(ByVal dataTable As bankDataSet12.cust1DataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy2(ByVal dataTable As bankDataSet12.cust1DataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As bankDataSet12.cust1DataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As bankDataSet12) As Integer
