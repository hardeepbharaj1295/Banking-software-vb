Public Class pickform
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        cmd = New SqlClient.SqlCommand("insert into trans values(" & number1 & ",'Withdrawing Money','" & TextBox8.Text & "','Personal','" & TextBox1.Text & "','" & TextBox2.Text & "')", vcon)
        cmd.ExecuteNonQuery()
        cmd.Dispose()
        MsgBox("Amount is successfully Withdrawn", MsgBoxStyle.Information, "Information")
        Me.Dispose()
    End Sub 
End Class